...
import {
  editPeriod,
  getPeriod as getPeriodFunc,
} from './../../../../../../lib/apis/periods';
...
const EditPeriod: React.FC<RouteComponentProps<props>> = (props) => {
  ...
  const getPeriod = async () => {
    await getPeriodFunc(props.match.params.id).then(async (res) => {
      if (res.status === 'SUCCESS' && res.period) {
        setName(res.period.name);
